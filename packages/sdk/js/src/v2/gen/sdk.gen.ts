...
export class Auth extends HeyApiClient {
  /**
   * Get saved provider auth
   *
   * Get saved authentication info for all providers (API keys, OAuth tokens, etc.).
   */
  public saved<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    },
    options?: Options<never, ThrowOnError>,
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "query", key: "directory" }] }])
    return (options?.client ?? this.client).get<ProviderAuthSavedResponses, unknown, ThrowOnError>({
...
export class Mcp extends HeyApiClient {
   ...
   * Delete MCP server
   *
   * Delete a Model Context Protocol (MCP) server from the system.
   */
  public delete<ThrowOnError extends boolean = false>(
    parameters: {
      name: string
    ...
    return (options?.client ?? this.client).delete<McpDeleteResponses, McpDeleteErrors, ThrowOnError>({
      url: "/mcp/{name}",
      ...options,
      ...params,
    })
