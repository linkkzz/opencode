...
const PLACEHOLDERS = [
  '随便问点什么... "对问卷调查数据.csv进行数据分析，将结果总结为飞书文档"',
  '随便问点什么... "统计用户反馈数据，生成改进建议并写入飞书文档"',
  '随便问点什么... "查看 mi.feishu.cn/docx/xxx 这个飞书文档的全部评论"',
  "随便问点什么... \"搜索标题包含'项目计划'的文档，对比其中的差异\"",
  '随便问点什么... "分析会议记录，提取决策事项并创建飞书文档"',
  '随便问点什么... "整理销售数据，生成季度业绩分析报告并写入飞书文档"',
  '随便问点什么... "优化 mi.feishu.cn/docx/xxx 这段话的表达，使其更加专业并更新"',
  '随便问点什么... "总结 mi.feishu.cn/docx/xxx 的核心要点，创建导读文档"',
  '随便问点什么... "查询 mi.feishu.cn/docx/xxx 这个飞书文档的全部评论"',
]
